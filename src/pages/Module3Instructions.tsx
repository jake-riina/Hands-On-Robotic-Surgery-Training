          ...
          <div className="max-w-6xl mx-auto">
            ...
            <div className="mx-auto text-center" style={{ marginBottom: '48px', maxWidth: '900px' }}>
              <p className="text-lg leading-relaxed" style={{ color: 'white', marginBottom: '16px' }}>
                Use the mock controller to move the rings to pegs on the opposite side by transferring each peg from one arm to the other. Rings will turn{' '}
                <strong style={{ color: PEG_TRANSFER_GREEN }}>green</strong> once a transfer is successfully completed.
              </p>
            </div>
