...
import { module3InstructionSteps } from '../config/module3InstructionSteps';
import { module3InstructionVisualForStepId } from './module3/Module3InstructionVisuals';
...
const Module3Instructions = () => {
  ...
  const decorateStep = useCallback((step: InstructionStep): InstructionStep => {
    return {
      ...step,
      visual: module3InstructionVisualForStepId(step.id),
    };
  }, []);
